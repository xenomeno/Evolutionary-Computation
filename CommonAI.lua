...
function table.binary_search(array, value, field)
  if value <= 0 then
    return 1
  elseif value >= (field and array[#array][field] or array[#array]) then
    return #array
  end
  ...
  while left + 1 < right do
    ...
    local item_value = field and array[middle][field] or array[middle]
    if value == item_value then
      return middle
  ...
  return (value <= (field and array[left][field] or array[left])) and left or right
end
